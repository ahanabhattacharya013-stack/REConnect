    ...
    extend: {
      ...
      colors: {
        ...
        pastel: {
          ...
          "pink-soft": "hsl(var(--pastel-pink-soft))",
          lavender: "hsl(var(--pastel-lavender))",
          "lavender-soft": "hsl(var(--pastel-lavender-soft))",
        },
        slate: {
      ...
      backgroundImage: {
        ...
        "gradient-card": "linear-gradient(145deg, hsl(var(--navy-dark)) 0%, hsl(var(--navy-deep)) 100%)",
      },
    },
  },
